...
<p align="center">
  Building at <a href="https://github.com/ctvc-pt">@ctvc-pt</a> and <a href="https://github.com/Honor-Growth">@Honor-Growth</a>
</p>
...
- **Voice & AI automation** — telephone agents, realtime audio pipelines, and workflow orchestration for real businesses.
- **Autonomous agent infrastructure** — running long-lived coding agents on remote machines, driven from chat.
- **Product & web** — B2B sites and mobile apps, from landing page to API.

### Featured work

| Project | What it is | Stack |
| --- | --- | --- |
| **[AI-Voice-Agent](https://github.com/RodrigoCorreia23/AI-Voice-Agent)** | Phone voice agent — Twilio media streams into the OpenAI Realtime API, with tool calls wired to n8n workflows | Node · Twilio · OpenAI |
| **[kirk](https://github.com/RodrigoCorreia23/kirk)** | Run autonomous Claude Code agents on a remote Linux box, each an isolated profile driven through Discord | Python · discord.py · systemd |
| **[honor-growth](https://github.com/RodrigoCorreia23/honor-growth)** | B2B site for Honor Growth — no build step, hand-rolled CSS, CSP/HSTS headers, auto-deployed | HTML · CSS · Cloudflare |
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/RodrigoCorreia23/RodrigoCorreia23/output/snake-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/RodrigoCorreia23/RodrigoCorreia23/output/snake.svg">
    <img src="https://raw.githubusercontent.com/RodrigoCorreia23/RodrigoCorreia23/output/snake.svg" width="98%" alt="Contribution snake">
  </picture>
</p>
